...
function init_ui() {
    ...
    if(sMenu_btn)
    {
        sMenu_btn.addEventListener('click', function(){            
            ...
            if(typeof play_sound !== 'undefined') play_sound(0);
        });
    }
    ...
    sClose_menu_btn.addEventListener('click', function(){
        if(typeof play_sound !== 'undefined') play_sound(1);
    ...
    sSearch_btn.addEventListener('click', function(){
        if(document.body.classList.contains('viewing-search')){
            if(typeof play_sound !== 'undefined') play_sound(5);
        }
        else{
            if(typeof play_sound !== 'undefined') play_sound(6);
    ...
    */
    ...
    // document.body.addEventListener('touchstart', function () {    
        if(typeof play_sound_random !== 'undefined') play_sound_random();
    });
