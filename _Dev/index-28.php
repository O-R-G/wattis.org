...
href="http://www.cca.edu" target="new">California College of the Arts</a> 
<canvas id="canvas7" width="50" height="22"><<⅂</canvas></span></div>
...
<div class="newsContainer"><span id="sentence6" class="red">#_# 
Friday, we are showing Joan Jonas films. Come.<canvas id="canvas14" 
width="20" height="24">!</canvas></span><canvas id="canvas11" width="12" 
height="24">!</canvas></div>
...
src="IMAGES/fti.gif"> here.<canvas id="canvas10" width="50" 
height="22">. . .</canvas> </span></div>

<!-- NEWSLETTER -->

<div class="newsletterContainer"><span id="sentence11"><i>Our newsletter</i> . . . <br /><form enctype='multipart/form-data' 
action='' method='post' style='margin: 0; padding: 0;'><textarea name='sender' cols='30' 
rows='1'class='Mono'></textarea><input name='subscribe' type='submit' 
value='Subscribe' /></form></span></div>
